                        ...
                        <li class="nav-item">
                            <button type="button" class="nav-link active" style="cursor: auto;">
                                <span class="d-flex justify-content-start align-items-center">
                                    ...
                                    <b style="margin-left: 12px;">Editar Curso de <span name="curso_titulo"></span></b>
                                </span>
                            </button>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane fade show active">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i class="bx bx-building-house"></i></span>
                                        <input type="number" class="form-control" name="duracao_total_horas" id="duracao_total_horas_edit" placeholder="Curso" />
                                    </div>
                                    <span class="text-danger">
                                        <strong id="duracao_total_horas-error-edit"></strong>
                                    </span>
                                </div>
                            </div>
                        </div>
