            ...
            <div class="modal-body">
                <div class="row mb-3">
                    <div class="col-6">
                        ...
                        <div class="input-group input-group-merge">
                            <span class="input-group-text"><i class="bx bx-book-reader" style="font-size: 12px;"></i></span>
                            <input type="text" class="form-control form-control-sm" name="disciplina" id="disciplina"
                    ...
                    <div class="col-6">
                        <label class="form-label" for="basic-icon-default-estate">Área de
                            Conhecimento</label>
                        <select class="form-select form-select-sm" name="area_conhecimento_id">
                ...
                <div class="row mt-5 mb-3">
                    <div class="col-6">
                        ...
                        <div class="input-group input-group-merge">
                            <span class="input-group-text"><i class="bx bx-webcam" style="font-size: 12px;"></i></span>
                            <input type="number" class="form-control form-control-sm" name="duracao_horas" id="duracao_horas" placeholder="Carga horária" />
                        </div>
                        <span class="text-danger">
