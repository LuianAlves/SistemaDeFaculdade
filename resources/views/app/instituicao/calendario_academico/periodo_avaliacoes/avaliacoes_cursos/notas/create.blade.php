...
<div class="modal fade" id="lancamentoDeNota" data-bs-backdrop="static" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <form class="modal-content" id="lancarNotas" action="{{ route('campus.store') }}" method="post">
            @csrf
...
@include('app.instituicao.calendario_academico.periodo_avaliacoes.avaliacoes_cursos.notas.notas_scripts')
