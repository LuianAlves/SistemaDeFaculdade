                    ...
                    <div class="card my-2">
                        ...
                        <div class="card-body">
                            <form class="mb-2" action="{{ route('notas.update') }}" method="post">
                                ...
                                <div class="row mt-3">
                                    <div class="col-2">
                                        <label class="form-label" for="nota_np1_sub">Quantidade de faltas</label>
                                        <div class="input-group input-group-merge">
                                            <input type="text" class="form-control" name="nota_np1_sub" id="nota_np1_sub" placeholder="NP1 Sub" value="{{$nota->nota_np1_sub}}">
                                        </div>
                                    </div>
                                    <div class="col-2">
                                        <label class="form-label" for="nota_np2_sub">Número de aulas no semestre</label>
                                        <div class="input-group input-group-merge">
                                            <input type="text" class="form-control" name="nota_np2_sub" id="nota_np2_sub" placeholder="NP2 Sub" value="{{$nota->nota_np2_sub}}">
                                        </div>
                                    </div>
                                </div>
